 ...
 * @author EQ
 */
public class TranslatingGlobse {
    ...
    public TranslatingGlobse() {
    }
    
    public static void main(String[] args) {
        TranslatingGlobse globse = new TranslatingGlobse();
    ...
    public void getTranslatingSynonyms(String spaWord){
        try {
            ...
            Logger.getLogger(TranslatingGlobse.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();
